...
export const TabSwitcher = ({ onClose, isPopup = false }: TabSwitcherProps) => {
  // 状态管理
  ...
  // 切换到选中的标签
  const switchToSelectedTab = async () => {
    ...
    <div className={containerClassName}>
      ...
      >
        <div className="plasmo-p-4 plasmo-bg-gray-100 plasmo-border-b plasmo-border-gray-200">
          <h2 className="plasmo-text-lg plasmo-font-medium plasmo-text-gray-800">最近访问的标签</h2>
          <p className="plasmo-text-sm plasmo-text-gray-500">使用方向键导航或数字键(1-{Math.min(9, tabs.length)})直接选择</p>
        </div>
