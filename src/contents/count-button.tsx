...
export const CountButton = () => {
  ...
  return (
    <button
      ...
      Count:
      <span className="plasmo-text-red-800 plasmo-inline-flex plasmo-items-center plasmo-justify-center plasmo-w-8 plasmo-h-4 plasmo-ml-2 plasmo-text-xs plasmo-font-semibold plasmo-rounded-full">
        {count}
      </span>
    </button>
  )
